...
class NodeGroupPayload(TypedDict):
    ...
    Attributes:
        ...
        payload_str: The formatted string to be sent as the 'nodes' parameter in the API request
                     for this group.
        config_key_scan_interval: The key used in Home Assistant configuration (options flow)
                                  to set the scan interval for this group (e.g., "scan_interval_realtime_core").
        default_scan_interval: The default scan interval in seconds for this group if not
