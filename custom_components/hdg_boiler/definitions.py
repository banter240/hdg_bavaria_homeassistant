...
def _create_sensor_definition(
    ...
    if hdg_enum_type is not None:
        definition["hdg_enum_type"] = hdg_enum_type
...
SENSOR_DEFINITIONS: Final[dict[str, SensorDefinition]] = {
    ...
    "nachlegeschritt_text": create_enum_sensor(
        key="nachlegeschritt_text",
        node_id="19T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_3"],
        enum_type="NACHLEGESCHRITT",
        icon="mdi:stairs-up",
    ),
    "nachlegeschritt": create_general_sensor(
        key="nachlegeschritt",
        node_id="19T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_3"],
        hdg_data_type="10",
    ...
    "nachlege_benachrichtigung": create_enum_sensor(
        ...
        node_id="20T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_3"],
        enum_type="NACHLEGEZEITPUNKT_BENACHRICHTIGUNG",
    ...
    "hk1_bezeichnung": create_text_sensor(
        key="hk1_bezeichnung",
        node_id="6021T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_4"],
    ...
    "anlagenbezeichnung_sn": create_text_sensor(
        key="anlagenbezeichnung_sn",
        node_id="20026T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_5"],
        icon="mdi:tag",
    ),
    "mac_adresse": create_text_sensor(
        key="mac_adresse",
        node_id="20031T",
        polling_group=POLLING_GROUP_KEYS["POLLING_GROUP_5"],
    ...
    "extra_version_info": create_text_sensor(
    ...
    "hydraulikschema_nummer": create_text_sensor(
    ...
    "kessel_typ_info_leer": create_text_sensor(
