...
CONF_DATA_REFRESH_PAYLOAD_MODE: Final[str] = "data_refresh_payload_mode"
...
DATA_REFRESH_PAYLOAD_MODE_AUTO: Final[str] = "auto"
DATA_REFRESH_PAYLOAD_MODE_LEGACY: Final[str] = "legacy"
DATA_REFRESH_PAYLOAD_MODE_INDEXED: Final[str] = "indexed"
DATA_REFRESH_PAYLOAD_MODES: Final[list[str]] = [
    DATA_REFRESH_PAYLOAD_MODE_AUTO,
    DATA_REFRESH_PAYLOAD_MODE_LEGACY,
    DATA_REFRESH_PAYLOAD_MODE_INDEXED,
]
DEFAULT_DATA_REFRESH_PAYLOAD_MODE: Final[str] = DATA_REFRESH_PAYLOAD_MODE_AUTO
